...
function Filter() {
    ...
    const {sortByPrice , filterByPrice , filterByRatings , filterByCategory}  = state 
            ...
            <aside className="filter-sidebar" >
                <div className="filter-container">
                    <div className="filter-head">
                        ...
                        <button className="text-underline m-0 btn-link" onClick={() => dispatch({ type: "CLEAR" })}>Clear</button>
                    </div>
                    ...
                    <div className="filter-content">
                        ...
                        <div className="filter-input-group">
                            ...
                            className="slider"
                              type="range"
                              value={ filterByPrice || 0 } min={0} step={2000} max={8000} 
                              onChange={(e) => {
                        ...
                        <div className="filter-input-group">
                            <label htmlFor="category1">
                                ...
                                onChange={() => dispatch({type:'CATEGORY_FILTER' , payload:'Men'}) }
                                /> Men
                            </label>
                            <label htmlFor="category2">
                                ...
                                onChange={() => dispatch({type:'CATEGORY_FILTER' , payload:'Women'}) }/> Women
                            </label>
                            <label htmlFor="category3">
                                ...
                                onChange={() => dispatch({type:'CATEGORY_FILTER' , payload:'Kids'}) }
                                /> Kids
                            </label>
                        </div>
                        <hr className='customDivider' />
